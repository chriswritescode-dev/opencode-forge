...
export async function createForgeCore(config: PluginConfig, host: ForgeHostInput): Promise<ForgeCore> {
  const { directory, projectId, projectRoot, client: forgeClient } = host
