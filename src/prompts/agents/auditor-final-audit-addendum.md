...
Every persisted finding must include exact sites, a realistic scenario, the smallest root-cause fix, an acceptance criterion, and narrow verification, consistent with the base prompt.
