...
Loop worktrees use OpenCode 2's native worktree and location model: no environment variable and no version floor. See [Workspace Integration](docs/workspaces.md).
