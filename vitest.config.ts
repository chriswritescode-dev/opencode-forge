...
export default defineConfig({
  ...
  test: {
    include: [
      ...
      'test/utils/coder-decisions.test.ts',
      ...
      'test/loop/finding-recurrence.test.ts',
      ...
      'test/loop/send-loop-prompt.test.ts',
      ...
      'test/workspace/forge-naming.test.ts',
      'test/workspace/forge-worktree.test.ts',
      'test/workspace/forge-adapter.test.ts',
      'test/workspace/forge-adapter-git-seam.test.ts',
      ...
      'test/utils/git-service.test.ts',
    ],
    globals: true,
  },
})
